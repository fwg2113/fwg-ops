      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            <div className="w-14 h-14 mx-auto mb-4 rounded-full bg-blue-600/20 flex items-center justify-center">
            ...
            <p className="text-3xl font-bold text-blue-500 mb-2">500+</p>
            <p className="text-gray-400 text-sm mb-1">Vehicles Wrapped</p>
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center gap-3">
              ...
              <div className="h-8 px-3 bg-gray-800 rounded flex items-center">
