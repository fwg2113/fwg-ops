      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            ...
            <p className="text-3xl font-bold text-[#CE0000] mb-2">13+</p>
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center gap-3">
              <div className="h-8 px-3 bg-zinc-800 rounded-lg flex items-center">
                <span className="text-gray-400 text-xs font-semibold">SunTek</span>
              </div>
              <div className="h-8 px-3 bg-zinc-800 rounded-lg flex items-center">
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center gap-2 text-xs text-gray-400">
              {['Quote', 'Drop Off', 'Install', 'Pick Up'].map((step, i) => (
            ...
            <p className="text-gray-400 text-xs mt-3">
              Simple, stress-free process from first call to finished vehicle.
            </p>
          </div>
        </div>
      </div>
