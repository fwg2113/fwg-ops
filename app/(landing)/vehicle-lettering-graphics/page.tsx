...
const page = PAGES['vehicle-lettering-graphics']
...
export default function VehicleLetteringGraphicsPage() {
  ...
  return (
    <>
      ...
      <HeroSection
        ...
        pageSlug="vehicle-lettering-graphics"
      />
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {page.services.map((s, i) => (
              <ServiceCard key={s.title} {...s} pageSlug="vehicle-lettering-graphics" index={i + 1} />
            ))}
          </div>
        </div>
      </section>
