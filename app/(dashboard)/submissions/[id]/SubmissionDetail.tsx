...
const FORM_TYPE_LABELS: Record<string, string> = {
  ...
  'ppf_landing': 'PPF',
  'ppf_pricing': 'PPF - Pricing',
  'ppf_tesla': 'PPF - Tesla',
  'ppf_luxury': 'PPF - Luxury',
          ...
          <div>
            ...
            <span style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              ...
              <span style={{
                ...
                fontWeight: 600,
                textTransform: 'uppercase',
                background: (submission.form_type || '').startsWith('ppf') ? 'rgba(34, 197, 94, 0.15)' : submission.form_type === 'automotive_styling' ? 'rgba(249, 115, 22, 0.15)' : submission.form_type === 'cafe_wrap' ? 'rgba(234, 179, 8, 0.15)' : submission.form_type === 'sticker_label' ? 'rgba(168, 85, 247, 0.15)' : submission.form_type === 'embroidery' ? 'rgba(236, 72, 153, 0.15)' : submission.form_type === 'ad_landing' ? 'rgba(239, 68, 68, 0.15)' : 'rgba(59, 130, 246, 0.15)',
                color: (submission.form_type || '').startsWith('ppf') ? '#22c55e' : submission.form_type === 'automotive_styling' ? '#f97316' : submission.form_type === 'cafe_wrap' ? '#eab308' : submission.form_type === 'sticker_label' ? '#a855f7' : submission.form_type === 'embroidery' ? '#ec4899' : submission.form_type === 'ad_landing' ? '#ef4444' : '#3b82f6',
              }}>
