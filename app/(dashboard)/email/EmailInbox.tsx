...
export default function EmailInbox() {
  ...
  const buildSignatureHtml = (sig: typeof signatures[0]): string => {
    ...
    const LOGO = 'https://fwg-ops.vercel.app/images/email-signature-badge.png'
...
<td style="padding:0 20px 0 0;vertical-align:middle;"><img src="${LOGO}" width="85" height="90" alt="Frederick Wraps" style="display:block;border:0;width:85px;height:90px;" /></td>
